...
<html lang="en">
  ...
  <body>
        ...
        <li>
          ...
          <ul>
            <li class="sub-item">
              ...
              <p><a href="advisorlogin.php" style="color:black">Dashboard</a></p>
            </li>
            <li class="sub-item">
            ...
            <span class="material-icons-outlined"> contact_support </span>
              <p><a href="bot.html" target="_blank"style="color:black">Faq</a></p>
            </li>
    ...
    <ul class="menu">
        <li class="menu-link"><a href="addgrace.php" class="text-item">GIVE GRACE</a></li>
        <li class="menu-link sub">
          <a href="failed.php" class="text-item">FAILED STUDENTS</a>
        </li>
  
        <!-- same dropdown elements for services section -->
  
        <li class="menu-link sub">
          <a href="report.php" class="text-item">REPORT</a>
        </li>
  
        <li class="menu-link"><a href="analysis.html" class="text-item" target="_blank">ANALYSIS</a></li>
